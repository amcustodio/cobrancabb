<?php namespace Ultrawave\CobrancaBB\Soap\Factories;
...
use Ultrawave\CobrancaBB\Constants\TipoCanal;
use Ultrawave\CobrancaBB\Soap\Config;

/**
 * Class BoletoFactory
 * @package Ultrawave\CobrancaBB\Soap\Factories
 */
class BoletoFactory
{
    /**
